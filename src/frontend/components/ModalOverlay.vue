        ...
        >
          ...
          <div v-if="type === 'club'" class="p-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 class="font-semibold text-gray-900 mb-4">Club Details</h3>
                <div class="space-y-3">
                  <div v-if="data.memberCount" class="flex items-center text-gray-600">
                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.196-2.121M9 12a3 3 0 100-6 3 3 0 000 6zm7-3a3 3 0 11-6 0 3 3 0 016 0zm-7 9c0-3 4-4 7-4s7 1 7 4v2H2v-2z" />
                    </svg>
                    <span>{{ data.memberCount }} members</span>
                  </div>
                  <div v-if="data.timeCommitment" class="flex items-center text-gray-600">
                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <span>{{ data.timeCommitment }}</span>
                  </div>
                  <div v-if="data.meetingFrequency" class="flex items-center text-gray-600">
                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                    <span>{{ data.meetingFrequency }}</span>
                  </div>
                  <div v-if="data.contactInfo?.email" class="flex items-center text-gray-600">
                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <!-- Tags -->
                <div v-if="data.tags && data.tags.length > 0" class="mb-6">
          ...
          <!-- Event Modal -->
          <div v-else-if="type === 'event'" class="p-8">
            <div class="flex justify-between items-start mb-8">
              <div class="flex-1 pr-6">
                <h2 class="text-2xl font-bold text-gray-900 mb-2">
                  {{ data.name }}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <div class="space-y-3">
                  ...
                  <div v-if="data.attendeeCount" class="flex items-center text-gray-600">
                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
                    </svg>
                    <span>{{ data.attendeeCount }} attending</span>
                  </div>
                  <div v-if="data.organizer" class="flex items-center text-gray-600">
                    <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                ...
                <div class="space-y-3 text-sm">
                  <div v-if="data.isFree" class="flex items-center text-green-600">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    </svg>
                    Free Event
                  </div>
                  <div v-if="data.isVirtual" class="flex items-center text-blue-600">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Professor Modal -->
          <div v-else-if="type === 'professor'" class="p-8">
            <div class="flex justify-between items-start mb-8">
              <div class="flex-1 pr-6">
                <h2 class="text-2xl font-bold text-gray-900 mb-2">
                  {{ data.name }}
            ...
            <div class="mb-8">
              <h3 class="font-semibold text-gray-900 mb-4">Research Areas</h3>
              ...
              <h3 class="font-semibold text-gray-900 mb-4">Why Connect</h3>
              <p class="text-gray-600 mb-6">
                {{ data.whyRecommended }}
              </p>
            </div>
