<template>
  ...
  >
    <div class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-y-auto border border-white/20">
      <!-- Header -->
      <div class="relative px-8 py-8 text-center">
        ...
        <!-- Welcome Animation -->
        <div class="mb-6">
          <div class="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-full flex items-center justify-center shadow-lg transform hover:scale-110 transition-transform duration-300">
      ...
      <div class="px-8 pb-8">
        <!-- Key Benefits Cards -->
        <div class="mb-8">
          <h2 class="text-2xl font-semibold text-gray-900 text-center mb-8">How OppTrack transforms your college experience</h2>
          
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Track Everything -->
            <div class="group bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div class="flex items-center mb-4">
                ...
                <h3 class="text-xl font-semibold text-gray-900">Track Everything</h3>
              </div>
            ...
            <!-- Resume Building -->
            <div class="group bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div class="flex items-center mb-4">
                ...
                <h3 class="text-xl font-semibold text-gray-900">Resume Building</h3>
              </div>
              <p class="text-gray-600 leading-relaxed">
            ...
            <!-- Balance Management -->
            <div class="group bg-gradient-to-br from-purple-50 to-violet-50 border border-purple-200 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div class="flex items-center mb-4">
                ...
                <h3 class="text-xl font-semibold text-gray-900">Balance Management</h3>
              </div>
              <p class="text-gray-600 leading-relaxed">
            ...
            <!-- Connect & Grow -->
            <div class="group bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div class="flex items-center mb-4">
                ...
                <h3 class="text-xl font-semibold text-gray-900">Connect & Grow</h3>
              </div>
              <p class="text-gray-600 leading-relaxed">
        ...
        <div class="text-center bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8 border border-indigo-200">
          <h3 class="text-2xl font-semibold text-gray-900 mb-4">Ready to get started?</h3>
