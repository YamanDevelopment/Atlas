<template>
  ...
  >
    ...
    >
      ...
      >
        <div v-if="isVisible" class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl max-w-4xl w-full max-h-[95vh] overflow-y-auto border border-white/20">
          <!-- Header -->
          ...
          <div class="px-8 pb-8">
            <!-- Key Benefits Cards -->
            <div class="mb-8">
              <h2 class="section-title text-2xl font-semibold text-gray-900 text-center mb-8">How OppTrack transforms your college experience</h2>
              
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <!-- Track Everything -->
                <div class="benefit-card group bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1" style="animation-delay: 0.1s">
                ...
                <Transition
                  ...
                  appear
                >
                  <div class="benefit-card group bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1" style="animation-delay: 0.2s">
                    <div class="flex items-center mb-4">
                ...
                <Transition
                  ...
                  appear
                >
                  <div class="benefit-card group bg-gradient-to-br from-purple-50 to-violet-50 border border-purple-200 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1" style="animation-delay: 0.3s">
                    <div class="flex items-center mb-4">
                ...
                <Transition
                  ...
                  appear
                >
                  <div class="benefit-card group bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-200 rounded-2xl p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1" style="animation-delay: 0.4s">
                    <div class="flex items-center mb-4">
