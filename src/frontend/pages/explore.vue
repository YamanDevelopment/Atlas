						...
						>
							<div class="p-8">
								<div class="mb-4">
									...
									<p class="text-indigo-600 text-xs mb-4 font-medium">
								...
								<div class="space-y-3 text-sm text-gray-500 mb-6">
									...
									<div class="flex items-center justify-between pt-2">
										<span
											v-if="event.isFree"
											class="px-3 py-1 text-xs bg-green-100/80 backdrop-blur-sm text-green-700 rounded-full font-medium"
										>Free</span>
			...
			>
				...
				>
					...
					>
						...
						>
							<div class="flex justify-between items-start mb-8">
								<div class="flex-1 pr-6">
									...
									<p class="text-indigo-600 text-sm mt-3 font-medium">
										{{ modalData.whyRecommended }}
									</p>
								</div>
								<button
										...
										<div class="flex items-center">
											...
											>
												<path
													...
													stroke-linejoin="round"
													stroke-width="2"
													d="M8 7V3a2 2 0 012-2h4a2 2 0 012 2v4m-4 8V9m-4 8h8"
												/>
											</svg>
						...
						<!-- Event Modal -->
						<div
							v-if="modalType === 'event' && modalData"
							class="p-8"
						>
							<div class="flex justify-between items-start mb-8">
								<div class="flex-1 pr-6">
						...
						<!-- Professor Modal -->
						<div
							v-if="modalType === 'professor' && modalData"
							class="p-8"
						>
							<div class="flex justify-between items-start mb-8">
								<div class="flex-1 pr-6">
									...
									<p class="text-gray-600 text-lg">
										{{ modalData.title }} • {{ modalData.department }}
									</p>
									<p class="text-indigo-600 text-sm mt-3 font-medium">
										{{ modalData.whyRecommended }}
									</p>
							...
							<div class="mb-8">
								...
								<div
									v-if="modalData.isAcceptingStudents"
									class="mb-6"
								>
